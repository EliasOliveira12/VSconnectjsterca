...
function CadastroUsuario() {
    ...
    const[emeil,setEmel] = useState<string>("")
    ...
    const [select, setSelect] = useState<string>(""); // state que contém a opção de skill selecionada pelo usuário
        function verificaCampoUpeload(event: any){
            ...
            function Cadastrar(event: any){
                ...
                const formdata = new FormData()
                 ...
                 formdata.append("email",emeil)
                 formdata.append("password",senha)
                 formdata.append("user_ img",foto)
        ...
        <main className="main_cadastro">
            <div className="container container_cad">
                <div className="cad_conteudo">
                    <h1>Cadastro</h1>
                    <hr />
                    <form onSubmit={Cadastrar} className="cad_formulario" method="POST">
                        ...
                        <div className="cad_box_input">
                            ...
                            <input
                                type="email"
                                id="email"
                                onChange={(event)=>{setEmel(event.target.value)}}
                        ...
                        <div className="cad_box_input">
                            <label htmlFor="foto">Foto:</label>t
                            {/* Passar primeiro como exemplo */}
                            <input
                                type="file"
                                id="foto"
                                onChange={verificaCampoUpeload}
                                required
                            />v
                        </div>
