...
function PerfilUsuario() {
    ...
    const[emeil,setEmeil] = useState<string>("")
            ...
            <div className="container container_perfil_dev">
                <div className="perfil_dev_conteudo">
                    ...
                    <div className="topo_dev">
                        <img src={"http://localhost:3000/static/"+foto} alt={"Foto de perfil de nome"+ nome} />
                        <h2>{nome}</h2>
                    </div>
                    ...
                    <div className="contato_local">
                        <div className="contato">
                            ...
                            <Link to={"mailto:"+ emeil}>{emeil}</Link>
                        </div>
                        <div className="local"> 
                            <svg
